Pod::Spec.new do |s|
  ...
  s.source = { :git => "https://git.yoomoney.ru/scm/sdk/yookassa-payments-swift.git", :tag => "6.15.0" }
  ...
  s.ios.dependency 'YandexMobileMetrica/Static', '> 4.0.0'
